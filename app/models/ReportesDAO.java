...
"	       GRP.CLI_NDCTO_PROF as cedula "+
"	       FROM   SAI.ART_MATERIAS AM, "+
"	       SAI.(select GRU_SEMESTRE,GRU_CODIGO, MAT_CODIGO, GRU_CUPO_ASIGNADO, CLI_NDCTO_PROF,CLI_TIPODCTO,CLI_TDCTO_PROF from SAI.ART_HISTORIA_GRUPOS union select GRU_SEMESTRE, GRU_CODIGO,MAT_CODIGO, GRU_CUPO_ASIGNADO, CLI_NDCTO_PROF,CLI_TIPODCTO,CLI_TDCTO_PROF from SAI.ART_GRUPOS_VIGENTES) GRP GRP "+
"	        WHERE       GRP.GRU_SEMESTRE = ? "+ // 12 semestre
"	        AND AM.MAT_SEMESTRE = GRP.GRU_SEMESTRE "+
"	        AND GRP.CLI_TIPODCTO <> 'OT' "+
"	        AND GRP.CLI_TDCTO_PROF <> 'OT' "+
