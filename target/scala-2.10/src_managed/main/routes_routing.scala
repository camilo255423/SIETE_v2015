...
// @LINE:25
private[this] lazy val controllers_Application_authenticate18 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:26
private[this] lazy val controllers_Informe2_informeProfesor19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informe2"))))
        

// @LINE:27
private[this] lazy val controllers_Informe3_informeProfesor20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informe3"))))
        

// @LINE:28
private[this] lazy val controllers_Informe1_informeProfesor21 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informeprofesor"))))
        

// @LINE:29
private[this] lazy val controllers_Informe2_informeProfesor22 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("heteroevaluacion"))))
        

// @LINE:30
private[this] lazy val controllers_Informe3_informeProfesor23 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informefinal"))))
        

// @LINE:31
private[this] lazy val controllers_Informe4_informeFacultad24 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informefacultad"))))
        

// @LINE:32
private[this] lazy val controllers_Informe5_informePrograma25 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informeprograma"))))
        

// @LINE:33
private[this] lazy val controllers_Informe6_informeParticipantes26 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informeparticipantes"))))
        

// @LINE:34
private[this] lazy val controllers_Application_cambioSemestre27 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("cambiosemestre"))))
...
// @LINE:28
case controllers_Informe1_informeProfesor21(params) => {
   call { 
...
// @LINE:31
case controllers_Informe4_informeFacultad24(params) => {
   call { 
...
// @LINE:32
case controllers_Informe5_informePrograma25(params) => {
   call { 
...
// @LINE:33
case controllers_Informe6_informeParticipantes26(params) => {
   call { 
...
// @LINE:34
case controllers_Application_cambioSemestre27(params) => {
   call { 
