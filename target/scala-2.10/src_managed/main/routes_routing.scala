...
// @LINE:19
private[this] lazy val controllers_Generador_index13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("generador/"),DynamicPart("documento", """[^/]+""",true))))
        

// @LINE:21
private[this] lazy val controllers_Admin_autocompleteLabel14 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("autocompleteLabel"))))
        

// @LINE:22
private[this] lazy val controllers_Admin_index15 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("admin"))))
        

// @LINE:23
private[this] lazy val controllers_Admin_borrar16 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("borrarpermiso"))))
        

// @LINE:24
private[this] lazy val controllers_Admin_insertar17 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("insertarpermiso"))))
...
// @LINE:26
private[this] lazy val controllers_Application_logout19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("logout"))))
        

// @LINE:27
private[this] lazy val controllers_Application_authenticate20 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:28
private[this] lazy val controllers_Informe2_informeProfesor21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informe2"))))
        

// @LINE:29
private[this] lazy val controllers_Informe3_informeProfesor22 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informe3"))))
        

// @LINE:30
private[this] lazy val controllers_Informe1_informeProfesor23 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informeprofesor"))))
        

// @LINE:31
private[this] lazy val controllers_Informe2_informeProfesor24 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("heteroevaluacion"))))
        

// @LINE:32
private[this] lazy val controllers_Informe3_informeProfesor25 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informefinal"))))
        

// @LINE:33
private[this] lazy val controllers_Informe4_informeFacultad26 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informefacultad"))))
        

// @LINE:34
private[this] lazy val controllers_Informe5_informePrograma27 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informeprograma"))))
        

// @LINE:35
private[this] lazy val controllers_Informe6_informeParticipantes28 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("informeparticipantes"))))
        

// @LINE:36
private[this] lazy val controllers_Application_cambioSemestre29 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("cambiosemestre"))))
...
// @LINE:19
case controllers_Generador_index13(params) => {
...
// @LINE:21
case controllers_Admin_autocompleteLabel14(params) => {
...
// @LINE:22
case controllers_Admin_index15(params) => {
   call { 
...
// @LINE:23
case controllers_Admin_borrar16(params) => {
   call { 
...
// @LINE:24
case controllers_Admin_insertar17(params) => {
   call { 
...
// @LINE:30
case controllers_Informe1_informeProfesor23(params) => {
   call { 
...
// @LINE:31
case controllers_Informe2_informeProfesor24(params) => {
   call { 
...
// @LINE:32
case controllers_Informe3_informeProfesor25(params) => {
   call { 
...
// @LINE:33
case controllers_Informe4_informeFacultad26(params) => {
   call { 
...
// @LINE:34
case controllers_Informe5_informePrograma27(params) => {
   call { 
...
// @LINE:35
case controllers_Informe6_informeParticipantes28(params) => {
   call { 
...
// @LINE:36
case controllers_Application_cambioSemestre29(params) => {
   call { 
